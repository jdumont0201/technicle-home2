...
class AppsPlotsPolicy extends StatelessWidget {
  @override
...
,
                Styles.ph1no("Plots", "Privacy policy"),
                Styles.pLastUpdated("    Last updated 2020, January 16th"),
                Paragraph(
                    "Technicle Ltd (\"we\" or \"us\" or \"our\") respects the privacy of our users (\"user\" or \"you\")."),
                Paragraph(
                  "This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our mobile application (the \"Application\") called \"Plots\".",
                ),
                Paragraph(
                    "  Please read this Privacy Policy carefully. IF YOU DO NOT AGREE WITH THE TERMS OF THIS PRIVACY POLICY, PLEASE  DO NOT ACCESS "
                        "THE APPLICATION. "),
                Paragraph("We reserve the right to make changes to this Privacy Policy at any time and for any reason."
                    ...
                    "This Privacy Policy does not apply to the third-party online/mobile store from which you install the Application or make payments, including any in-game virtual"
                    "items, which may also collect and use data about you. We are"
                    "not responsible for any of the data collected by any such third party."),
                Styles.pTitle("COLLECTION OF YOUR INFORMATION"),
                Paragraph("The Application allows users to manage movie making projects and analyse movie characters, . Users can add data on existing movies or personal projects."

                    "The Application does collect the information related to these projects, such as entered movie names and properties, characters, scenes and locations."
                    "We may collect information about you in a variety of ways."
                    "The information we may collect via the Application depends 0on the content and materials you use, and includes:"),
                HeadedParagraph("Personal Data",
                    "Demographic and other personally identifiable information (such as your name and email address) that you voluntarily give to us when choosing to participate in  various activities related to the Application, such as chat, posting messages in comment sections or in our forums, liking posts, sending feedback, andresponding to surveys. If you choose to share data about yourself via your profile, online chat, or other interactive areas of the Application, please be advised that all data you disclose in these areas in public and your data will be accessible to anyone who accesses the Application."),
                HeadedParagraph("Derivative Data",
                ...
                HeadedParagraph("Financial Data",
                ...
                HeadedParagraph("Facebook Permissions",
                ...
                HeadedParagraph("Data from Social Networks",
                ...
                HeadedParagraph("Geo-Location Information",
                ...
                HeadedParagraph("Mobile Device Access",
                    "We may request access or permission to certain features from your mobile device, including your mobile device’s [list all features that your app can connect to (eg. bluetooth)]. If you wish to change our access or permissions, you may do so in your device’s settings.0"),
                HeadedParagraph("Mobile Device Data",
                    "Device information such as your mobile device ID number, model, and manufacturer, version of your operating system, phone number, country, location, and any other data you choose to provide."),
                HeadedParagraph("Push Notifications",
                    "We may request to send you push notifications regarding your account or the Application. If you wish to opt-out from receiving these types of communications, you may turn them off in your device’s settings."),
                HeadedParagraph("Third-Party Data",
                ...
                HeadedParagraph("Cookies and Web Beacons",
                ...
                Paragraph("If you have questions or comments about this Privacy Policy, please contact us at:"
